...
- ¿Qué diferencia hay entre un servidoe Express y Apache (el de la práctica A)? El servidor Express se está ejecutando en la máquina Host mientras que el servidor Apache se ejecuta en un contenedor.
